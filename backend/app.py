...
app = FastAPI(title="TARA-3D Single-View Height Estimation and 3D Flythrough (SIH26175)")
...
async def reconstruct(
    ...
    # Ingestion: Check for Georeferenced GeoTIFF metadata
    ...
    # Use origin-relative paths (eliminates localhost hardcoding)
    return {
        "status": "success",
        ...
        "effective_relief_m": round(elev_max - elev_min, 2),
        "bounds": list(bounds),
        "accuracy": accuracy,
